...
const SearchPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8">
      <div className="my-6">
        <h1 className="font-bold text-xl md:text-2xl mt-10">result for "{query}"</h1>
        <p>
          Showing results for {""}
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-32 dark:bg-gray-900 p-6">
      ...
      <Link to="/courses" className="italic">
        <Button variant="link" className={"text-blue-600  hover:text-white"}>Browse All Courses</Button>
      </Link>
    </div>
  );
};
